...
public:
    ...
    void setupUi(QMainWindow *TPAlgoritmos)
    {
        ...
        TPAlgoritmos->setWindowModality(Qt::ApplicationModal);
        TPAlgoritmos->resize(629, 452);
        TPAlgoritmos->setMaximumSize(QSize(629, 452));
...
""));
        ...
        fondo->setGeometry(QRect(-10, 10, 641, 471));
        fondo->setStyleSheet(QStringLiteral("image: url(:/imagenes/rts.png);"));
    ...
    {
        TPAlgoritmos->setWindowTitle(QApplication::translate("TPAlgoritmos", "RTS", 0));
